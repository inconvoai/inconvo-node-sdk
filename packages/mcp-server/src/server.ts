...
import { ClientOptions } from 'inconvo';
...
export { ClientOptions } from 'inconvo';
...
export function initMcpServer(params: {
  ...
  const client = new Inconvo(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client = params.client || new Inconvo({ defaultHeaders: { 'X-Stainless-MCP': 'true' } });
