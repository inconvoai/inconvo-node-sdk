...
[![NPM version](<https://img.shields.io/npm/v/inconvo-js.svg?label=npm%20(stable)>)](https://npmjs.org/package/inconvo-js) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/inconvo-js)

This library provides convenient access to the Inconvo REST API from server-side TypeScript or JavaScript.

The REST API documentation can be found on [inconvo.com](https://inconvo.com/docs). The full API of this library can be found in [api.md](api.md).
...
List methods in the Inconvo API are paginated.
...
1. Via the `INCONVO_LOG` environment variable
...
const client = new Inconvo({
  logger: logger.child({ name: 'Inconvo' }),
...
```ts
import Inconvo from 'npm:inconvo-js';
...
We are keen for your feedback; please open an [issue](https://www.github.com/ten-dev/inconvo-node-js/issues) with questions, bugs, or suggestions.
