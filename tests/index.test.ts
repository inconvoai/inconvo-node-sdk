...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    test('default logLevel is warn', async () => {
      const client = new Inconvo({ apiKey: 'My API Key', baseURL: 'My Base URL' });
    ...
    test('debug logs happen with debug env var', async () => {
      ...
      const client = new Inconvo({ logger: logger, apiKey: 'My API Key', baseURL: 'My Base URL' });
  ...
  test('maxRetries option is correctly set', () => {
    const client = new Inconvo({ maxRetries: 4, apiKey: 'My API Key', baseURL: 'My Base URL' });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new Inconvo({ apiKey: 'My API Key', baseURL: 'My Base URL' });
  ...
  test('with environment variable arguments', () => {
    ...
    process.env['INCONVO_API_URL'] = 'My Base URL';
    const client = new Inconvo();
  ...
  test('with overridden environment variable arguments', () => {
    ...
    process.env['INCONVO_API_URL'] = 'another My Base URL';
    const client = new Inconvo({ apiKey: 'My API Key', baseURL: 'My Base URL' });
    expect(client.apiKey).toBe('My API Key');
    expect(client.baseURL).toBe('My Base URL');
  });
...
describe('retries', () => {
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new Inconvo({ apiKey: 'My API Key', baseURL: 'My Base URL', fetch: testFetch });
